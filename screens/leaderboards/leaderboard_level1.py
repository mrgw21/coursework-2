...
class LeaderboardLevel1(BaseScreen):
    def __init__(self, screen, manager):
        ...
        self.buttons = ["Level 1", "Level 2", "Level 3"]
        self.selected_button = "Level 1"  # Default selection
    ...
    def draw(self):
        ...
        # Subtitle
        title_2_text = self.font_title_2.render("Level 1", True, (0, 0, 139))  # Dark Blue
